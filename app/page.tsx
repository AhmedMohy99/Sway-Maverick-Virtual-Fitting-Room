...
// Dynamically import FittingRoom to avoid SSR issues
  ...
  return (
    <main className="w-screen h-screen bg-black text-white overflow-hidden flex flex-col lg:flex-row">
      ...
      <div className="relative w-full lg:w-3/5 h-1/2 lg:h-full border-b lg:border-b-0 lg:border-r border-[#1a1a1a]">
        ...
        {/* Auto-Rotate Toggle - Positioned absolutely */}
      ...
      <div className="relative w-full lg:w-2/5 h-1/2 lg:h-full bg-black overflow-y-auto overflow-x-hidden">
        <div className="w-full h-full p-6 lg:p-8 space-y-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-xl lg:text-2xl font-bold text-[#00FFFF]">730 EGP</span>
              <span className="text-sm text-gray-500 line-through">950 EGP</span>
              <span className="px-2 py-1 bg-[#00FFFF]/10 border border-[#00FFFF]/30 text-[#00FFFF] text-xs font-bold tracking-wider">
                -23%
              </span>
            </div>
          </motion.div>
